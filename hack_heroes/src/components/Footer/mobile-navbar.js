...
export default function MobileNavbar() {
    ...
    const { user } = context;
    return (
        <section className="fixed backdrop-blur-navbar-blur flex justify-evenly items-center mt-2 h-auto p-2 bottom-0 right-0 w-full bg-navbar-background md:hidden">
