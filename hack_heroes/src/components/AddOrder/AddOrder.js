...
const AddOrder = () => {
    ...
    return (
        <div>
            <button onClick={ () => { router.push('/') }} className="fixed drop-shadow-xl text-white px-6 py-4 m-4 bg-graphite rounded-lg hover:bg-lite-graphite focus:bg-super-lite-graphite">Powrót</button>
            ...
            <div className="flex justify-center items-center">
                <form onSubmit={handleSubmit} className="  border-solid border-2 border-gray-400 grid lg:grid-cols-2 sm:grid-col-1 drop-shadow-md gap-12 w-full rounded-lg shadow-md bg-white-smoke p-10 ">
                    ...
                    <div className="flex flex-col">
                        ...
                        <input required ref={priceRef} className=" w-96 text-xl rounded-lg bg-gray-300 mt-2 outline-none p-2 border-solid border-2 border-gray-400 focus:border-gray-300" type="number" min="1" max="1000"/>
                    </div>
                    <div className="flex flex-col">
